...
authors-db:
	docker compose -f local.yml exec postgres psql --username=johndiginee --dbname=authors-live
...
search-index-create:
	docker compose -f local.yml exec api python3 manage.py search_index --create
