...
from .execptions import CantFollowYourself
...
class ProfileDetailAPIView(generics.RetrieveAPIView):
    """Display profile detail API view."""
...
class FollowingListView(APIView):
    """Display following list API view."""
...
class UnfollowAPIView(APIView):
    ...
    def post(self, request, user_id, *args, **kwargs):
        ...
        formatted_response = {
            "status_code": status.HTTP_200_OK,
            "message": f"You have unfollowed {profile.user.first_name} {profile.user.last_name}, since you were not following them in the first place.",
        }
